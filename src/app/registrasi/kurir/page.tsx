...
export default function RegistrasiKurir() {
    ...
    const fetchRegistrations = async () => {
        try {
            const response = await axios.get('/api/registrasi/kurir');
    ...
    return (
        <div className="p-16 w-screen min-h-screen">
            <h1 className="text-xl font-semibold mb-4">Registrations Kurir Approval</h1>
                        ...
                        <tr key={registration.id}>
                            ...
                            <td className="p-3 border flex justify-center">
                                {registration.detail === 'Photo' ? (
                                    ...
                                    <span className="flextext-black font-normal text-sm border border-xl bg-green-500 rounded-xl px-2 py-1">Confirmed</span>
                                )}
                            </td>
                        </tr>
                    ))}
